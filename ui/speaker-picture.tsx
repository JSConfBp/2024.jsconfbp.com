...
const breakpoints = [[0, 374], [375, 799], [800, 1023], [1024, 1279], [1280, 1919], [1920, Infinity]];
...
function SpeakerPicture({
  ...
  return (
    <div className={classNames(styles.image, styles[`image-${align}`], className, "x-container")}>
      <Image
        src={image}
        alt={alt}
        fill
