...
function MCList() {
  return (
    <div className={`col md-row gap-2p5 mb-2 mt-4 ${styles["mc-list"]}`}>
      <div className={`col gap-2p5 md-row ${styles["mc-list-item"]}`}>
        ...
        <div className={styles.text}>
          ...
          <Link href="https://twitter.com/AnjanaVakil" className={styles.link}>
            @AnjanaVakil
          </Link>
          <p>
            Engineering & teaching & learning ✨ Independent Developer Educator
      ...
      <div className={`col gap-2p5 md-rrow ${styles["mc-list-item"]}`}>
        ...
        <div className={styles.text}>
          ...
          <Link href="https://twitter.com/TejasKumar_" className={styles.link}>
            @TejasKumar_
          </Link>
