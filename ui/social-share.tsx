...
function SocialShare({
  ...
  const metaDescription =
    description ??
    "JSConf Budapest 2024, June 26-28, Budapest, Hungary. Tickets from €450, including free workshops, inclusive catering and barista coffee!";
  const socialImgAbsoluteUrl = `https://jsconfbp.com/${socialShareImage ?? "social-share/index.png"}`;
  ...
  return (
    <Head>
      ...
      <meta
        ...
        content="JSConf Budapest June 26-28, 2024 logo"
        key="og:image:alt"
      />
