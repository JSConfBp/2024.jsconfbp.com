...
function CallForPapers() {
  return (
    <>
      ...
      <ColoredSection>
        <h2 className="mt-0">JSConf Budapest 2024 Call for Speakers</h2>
        <p>
          We are inviting the JavaScript community to submit talks for the
          upcoming JSConf Budapest (June 27-28, 2024, Budapest, Hungary).
        </p>
        ...
        <p>
          ...
          form, which we'll check when we de-anonimize the talks at the end of
          the evaluation process.
        </p>
      </ColoredSection>

      <CenteredButton
        href="https://forms.gle/y3RN28awvwjkm2ws6"
        className="mb-2"
      >
      ...
      <ColoredSection background="light-section">
        ...
        <ul>
          <li>
            Latest cutting-edge technological advances in the world of
            JavaScript or computer science in general, if somehow applicable to
            JavaScript.
          </li>
          ...
          <li>
            Modern re-visit of programming fundamentals or software
            architectures using JS / TS and the Web
          </li>
          <li>Crossroads of Technologies</li>
          <li>
            ...Anything you want, that you feel passionate about and relates to
            the Web or JavaScript
          </li>
        </ul>
      </ColoredSection>
      ...
      <ColoredSection>
        ...
        <ul>
          <li>
            ...
            booking your itinerary, but if you wish to book yourself then
            invoice us later, that's also possible within reasonable price
            ranges.
          </li>
        </ul>
        <strong>
        ...
        <ul>
          <li>
            In a great hotel near the venue (including free WiFi) for the days
            of the conference, a day before, and the weekend after (i.e. June
            29-30th). If you want to stay longer, we can arrange things, just
        ...
        <ul>
          <li>
            You can bring your significant other, bring your kid(s), they'll
            stay with you at the hotel. If you need child-care to be sorted out
            for the time of the conference, please also get in touch. We are
            here to make this as easy for you as possible!
          </li>
        </ul>
        <p>
          If your employer can cover your travel and hotel, we are happy to list
          them as an awesome company partner. The money we save will be used to
      ...
      <ColoredSection background="light-section">
        <h2>Guidelines</h2>
        <strong>
          Submit your proposal by January 26th 2024, 23:59:59 CEST.
        </strong>
        <p>
          We're aiming at the most bias-free selection process as possible, so
          we ask you to help us. Omit any detail, url, company name from your
          the title and abstracts - for such details, we provide a separate
          field on the CFP form.
        </p>
        <strong>All talks are in English.</strong>
        <p>
          Talks are usually 30 minutes long (for longer talks we’d get in touch
          with you directly). There will be no Q&A on stage after the talks - we
          encourage attendees and speakers to talk to each in the breaks, after
          the sessions.
        </p>
        <p>
        ...
        <p>
          Original topics - one of the things we like to do with JSConf Budapest
          is to push the community forward. We can’t do this if the same people
          keep talking about the same things all the time. Thus, we favor
          original content. If you want to discuss a topic that you have talked
          about elsewhere, try to add a twist, or new research, or development,
          something unique. Of course, if your talk is plain awesome as-is, go
          for that :)
        </p>
        <p>
      ...
      <ColoredSection>
        ...
        <ul>
          <li>
            We anonymize submissions, so we don’t bias against anything related
            to the submitter. No peeking!
          </li>
          <li>
          ...
          <li>
            At the end, we de-anonymize the final shortlist so we can take
            speaker details as a factor in the final selection.
          </li>
        </ul>
        <p>
          We follow the{" "}
          <Link
            href="https://blog.cssconf.eu/2015/08/15/a-talk-selection-process-explained"
            target="_blank"
          >
      ...
      <ColoredSection background="light-section">
        ...
        <p>
          ...
          knows they have something great to talk about. There are about a
          million reasons why you don’t consider yourself a speaker.
        </p>
        <p>
          We are here to prove you wrong.If all you have is a gut feeling that
          you should be on stage, we are here to reach out and help you to
          develop or hone the skills you think you lack to deliver a great
          presentation.
        </p>
        <p>
          We are happy to brainstorm your interests to see if a great topic is
          hiding.We are happy to connect you with experienced speakers to help
          prepare your submission. We are happy to review and advise on how to
          produce a slide deck.
        </p>
        <p>
          If you need practice giving talks, get in touch, we can connect you
          with local groups.Again, whatever else you might need, we’re here to
          help.
        </p>
        <p>
          Get in touch:{" "}
          <Link href="mailto:team@jsconfbp.com" target="_blank">
            team@jsconfbp.com
          </Link>
          <br />
