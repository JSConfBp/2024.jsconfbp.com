...
import styles from "./call-for-papers.module.scss"
    ...
    <Layout title="Call for papers" pathName="/call-for-papers" >
      <div className={styles.cfp}>
        <section>
          ...
          <strong className={styles.deadline}>This Call for Speakers closes on January 26th, 2024!</strong>
        ...
        <section className={styles.perks}>
          ...
          <strong>Your travel to Budapest covered</strong><p>We literally buy your plane or train ticket, plus your airport transfer, and travel around the city. If you wish, you can arrange your travels, and invoice us later - we are happy to assist with booking your itinerary, but if you wish to book yourself then invoice us later, that's also possible within reasonable price ranges.</p>
          <strong>Your stay in Budapest covered + and extra weekend to explore our city</strong>
          <p>In a great hotel near the venue (including free WiFi) for the days of the conference, a day before, and the weekend after (i.e. Sept 28th-29th). If you want to stay longer, we can arrange things, just let us know, but you may have to cover extra nights, though.</p>
          <strong>Entrance to the conference</strong>
          <p>We probably won’t be done with the speaker selections by the end of the ticket sales, so if you want to make sure you can attend, just drop a mail to us and we will reserve a ticket for you (just don't mention anything related your talk in that mail please). If you get selected to speak and if you need to, we can refund your ticket, or you can transfer it to anyone you like.</p>
          <strong>You can bring your family</strong>
          <p>You can bring your significant other, bring your kid(s), they'll stay with you at the hotel. If you need child-care to be sorted out for the time of the conference, please also get in touch. We are here to make this as easy for you as possible!</p>
        ...
        <section>
          <h2>Guidelines</h2>
          <strong className={styles.deadline}>Submit your proposal by January 26th 2024, 23:59:59 CEST.</strong>
        ...
        <section>
          ...
          <p className={styles.process}>We follow the <a href="">selection process developed by our mentors at JSConf & CSSconf EU</a> and value:</p>
          <ul>
          ...
          <p>in a submission.</p>
          <p>Check out our <a href="">blogpost on how we manage to evaluate the CFP submissions.</a></p>
        </section>
        <section>
          ...
          <strong>Get in touch: team@jsconfbp.com</strong>
          <p>(just please don’t use this address to submit a proposal).</p>
        </section>
        <section>
          <CfpButton>Submit your talk proposal with Google Forms</CfpButton>
        </section>
