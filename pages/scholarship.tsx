...
function Scholarship() {
  return (
    <>
      ...
      <ColoredSection>
        <p>
          2024 will be the 6th time when we're running our Scholarship Program!
          As every year so far, we'll provide several free, Scholarship tickets
          to help underrepresented groups in tech to attend the conference.
        </p>

        <p>
          Anyone from an underrepresented group in tech is invited to apply for
          a scholarship. This includes but isn't limited to: women, people of
          color, LGBTQIA+ people, disabled people, and people facing economic or
          social hardships. We want to give them a chance.
        </p>
      ...
      <ColoredSection background="light-section">
        ...
        <p>
          The budget is filled by generous donors, both from the Attendees and
          our Partners.
        </p>

        <p>
          Attendees can sponsor the Program with buying Supported tickets. Both
          Early Bird and Regular tickets are available in a Scholarship
          Supporting variant. This means that the ticket price includes a
          percent of a supported ticket that will be given to someone in need.
        </p>
        ...
        <p>
          ...
          So all of our partners become donors to the Program. If your company
          is interested in participating, check out our{" "}
      ...
      <ColoredSection>
        ...
        <p>
          Scholarship Support is not money for a party, nor for fancy catering,
          or a nice booth.
        </p>
        ...
        <p>
          This is a chance for them, to meet people they can learn from, see
          talks they can benefit from, a chance to step forward.
        </p>
        ...
        <p>
          ...
          <Link
            target="_blank"
            href="https://medium.com/@_nec/how-can-a-conference-help-someone-5a4fff2623af#.gw1ni84hj"
          >
      ...
      <ColoredSection background="light-section">
        ...
        <p>
          ...
          itself, we ask applicants a few questions about what they do in tech
          or what they wish to learn on the event. These answers are helpful for
          the jury, who will evaluate the applications and award the tickets.
        </p>

        <p>
          We, the organizers, do not take part in the jury process. Every year
          we work with organizations that are specialized in career development
          and education in tech. They help us to evaluate the applications and
          select the awardees.
          {/* In the past
